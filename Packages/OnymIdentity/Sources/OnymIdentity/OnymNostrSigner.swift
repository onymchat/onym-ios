...
public struct OnymNostrSigner: NostrSigner {
    ...
    public static func ephemeral() throws -> OnymNostrSigner {
...
public struct OnymNostrSignerProvider: NostrEphemeralSignerProvider {
    public init() {}

    public func makeEphemeralSigner() throws -> any NostrSigner {
