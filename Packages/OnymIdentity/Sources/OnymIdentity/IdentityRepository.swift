...
public actor IdentityRepository: InvitationEnvelopeDecrypting, InvitationEnvelopeSealing, IdentitiesProviding {
    public static let shared = IdentityRepository()
    ...
    @discardableResult
    public func bootstrap() async throws -> Identity {
    ...
    @discardableResult
    public func add(name: String? = nil, mnemonic: String? = nil) async throws -> IdentityID {
        try await ensureLoaded()
    ...
    public func select(_ id: IdentityID) async throws {
        try await ensureLoaded()
    ...
    public func remove(_ id: IdentityID) async throws {
        try await ensureLoaded()
        guard cache[id] != nil else { return }
    ...
    ///   on this device.
    public func rename(_ id: IdentityID, newName: String) async throws {
        try await ensureLoaded()
    ...
    @discardableResult
    public func restore(mnemonic: String) async throws -> Identity {
    ...
    public func currentIdentity() -> Identity? {
    ...
    public func currentSelectedID() -> IdentityID? {
        currentID
    }
    ...
    public func currentIdentityName() -> String? {
        guard let currentID else { return nil }
    ...
    public func currentIdentities() async throws -> [IdentitySummary] {
        try await ensureLoaded()
    ...
    public func blsSecretKey() throws -> Data {
    ...
    public nonisolated var identitiesStream: AsyncStream<[IdentitySummary]> {
        AsyncStream { continuation in
            let id = UUID()
    ...
    public nonisolated var currentIdentityID: AsyncStream<IdentityID?> {
        AsyncStream { continuation in
            let id = UUID()
    ...
    public nonisolated var identityRemoved: AsyncStream<IdentityID> {
        AsyncStream { continuation in
            let id = UUID()
    ...
    public func decryptInvitation(envelopeBytes: Data, asIdentity identityID: IdentityID) throws -> Data {
    ...
    public static func decryptSealedEnvelope(
        envelopeBytes: Data,
...
/// in-memory variant.
public struct SelectedIdentityStore: Sendable {
    let load: @Sendable () -> IdentityID?
    let save: @Sendable (IdentityID?) -> Void

    public static let userDefaults: SelectedIdentityStore = {
    ...
    public static func inMemory(initial: IdentityID? = nil) -> SelectedIdentityStore {
...
public struct ProtectedDataAvailability: Sendable {
    ...
    public init(isAvailable: @escaping @Sendable () async -> Bool) {
        self.isAvailable = isAvailable
    }

    public static let uiApplication = ProtectedDataAvailability {
...
public struct InstallMarker: Sendable {
    public let exists: @Sendable () -> Bool
    let set: @Sendable () -> Void

    public static let userDefaults: InstallMarker = {
    ...
    public static func inMemory(initiallySet: Bool = false) -> InstallMarker {
