...
@MainActor
@Observable
public final class IdentitiesFlow {
    ...
    public var currentID: IdentityID?
    ...
    public var pendingMnemonic: String = ""
    ...
    public var pendingRemoval: IdentitySummary?
    ...
    public var pendingRemovalConfirmText: String = ""

    private let repository: IdentityRepository
    private var streamingTask: Task<Void, Never>?

    public init(repository: IdentityRepository) {
    ...
    public func select(_ id: IdentityID) {
    ...
    public func rename(_ id: IdentityID, newName: String) {
    ...
    public func startRemoval(of summary: IdentitySummary) {
    ...
    public var canConfirmRemoval: Bool {
    ...
    public func blsPrefix(of summary: IdentitySummary) -> String {
