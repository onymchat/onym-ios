...
public protocol ChainStateReading: Sendable {
...
public struct SEPContractChainStateReader: ChainStateReading {
...
public enum ChainReadError: Error, Equatable, Sendable {
