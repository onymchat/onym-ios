...
public struct ContractsState: Equatable, Sendable {
    public let manifest: ContractsManifest
    public let selections: [AnchorSelectionKey: String]

    public static let empty = ContractsState(manifest: .empty, selections: [:])
    ...
    public func binding(for key: AnchorSelectionKey) -> AnchorBinding? {
    ...
    /// newest-first order.
    public func availableReleases(for key: AnchorSelectionKey) -> [ContractRelease] {
    ...
    /// ship there.
    public func hasAnyContracts(network: ContractNetwork) -> Bool {
...
public actor ContractsRepository {
    ...
    public init(fetcher: any ContractsManifestFetcher, store: any AnchorSelectionStore) {
    ...
    /// release's contract.
    public func select(key: AnchorSelectionKey, releaseTag: String) {
    ...
    public func clearSelection(key: AnchorSelectionKey) {
        var selections = cached.selections
    ...
    public func currentState() -> ContractsState { cached }
    ...
    public nonisolated var snapshots: AsyncStream<ContractsState> {
