...
/// "default to latest".
public struct AnchorSelectionKey: Codable, Equatable, Hashable, Sendable {
    public let network: ContractNetwork
    public let type: GovernanceType

    public init(network: ContractNetwork, type: GovernanceType) {
...
public struct AnchorBinding: Codable, Equatable, Hashable, Sendable {
