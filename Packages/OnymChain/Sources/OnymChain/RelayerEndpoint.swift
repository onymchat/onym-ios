...
public struct RelayerEndpoint: Codable, Equatable, Hashable, Identifiable, Sendable {
    ...
    public static let customNetwork = "custom"
    ...
    public static func custom(url: URL) -> RelayerEndpoint {
        RelayerEndpoint(
    ...
    public init(name: String, url: URL, networks: [String]) {
        self.name = name
        self.url = url
...
public struct KnownRelayersDocument: Codable, Equatable, Sendable {
    public let version: Int
    public let relayers: [RelayerEndpoint]
}
...
public enum RelayerStrategy: String, Codable, CaseIterable, Hashable, Sendable {
...
public struct RelayerConfiguration: Codable, Equatable, Hashable, Sendable {
    public let endpoints: [RelayerEndpoint]
    ...
    public let strategy: RelayerStrategy
    ...
    public static let empty = RelayerConfiguration(
        endpoints: [],
        primaryURL: nil,
        strategy: .random,
    ...
    public func selectURL<R: RandomNumberGenerator>(using rng: inout R) -> URL? {
