...
public struct GroupCreateProof: Equatable, Sendable {
    public let proof: Data
    public let publicInputs: [Data]

    public init(proof: Data, publicInputs: [Data]) {
        self.proof = proof
    ...
    /// contract will store.
    public var commitment: Data { publicInputs[0] }
    ...
    /// as `publicInputs[2]`.
    public var adminPubkeyCommitment: Data { publicInputs[2] }
}
...
public protocol GroupProofGenerator: Sendable {
...
/// group_id_fr`).
public struct GroupUpdateProof: Equatable, Sendable {
    public let proof: Data
    public let publicInputs: [Data]
    ...
    public var commitmentNew: Data { publicInputs[2] }
...
public struct GroupProofUpdateInput: Sendable {
    public let groupType: SEPGroupType
    public let tier: SEPTier
    public let oldMembers: [GovernanceMember]
    public let adminBlsSecretKey: Data
    public let adminIndexOld: Int
    public let epochOld: UInt64
    public let memberRootNew: Data
    public let groupID: Data
    public let saltOld: Data
    public let saltNew: Data

    public init(
        groupType: SEPGroupType,
        tier: SEPTier,
        oldMembers: [GovernanceMember],
        adminBlsSecretKey: Data,
        adminIndexOld: Int,
        epochOld: UInt64,
        memberRootNew: Data,
        groupID: Data,
        ...
        self.tier = tier
        self.oldMembers = oldMembers
        self.adminBlsSecretKey = adminBlsSecretKey
        self.adminIndexOld = adminIndexOld
        self.epochOld = epochOld
        self.memberRootNew = memberRootNew
        self.groupID = groupID
        self.saltOld = saltOld
...
public struct GroupProofCreateInput: Sendable {
    ...
    public var peerBlsSecretKey: Data? = nil
    ...
    public init(
        ...
        self.groupID = groupID
        self.salt = salt
        self.peerBlsSecretKey = peerBlsSecretKey
    }
}

public enum GroupProofGeneratorError: Error, Equatable, Sendable {
...
public struct OnymGroupProofGenerator: GroupProofGenerator {

    public init() {}

    public func proveCreate(_ input: GroupProofCreateInput) throws -> GroupCreateProof {
    ...
    public func proveUpdate(_ input: GroupProofUpdateInput) throws -> GroupUpdateProof {
        switch input.groupType {
        case .tyranny:
