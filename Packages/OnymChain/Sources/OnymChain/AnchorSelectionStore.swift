...
public protocol AnchorSelectionStore: Sendable {
...
public struct UserDefaultsAnchorSelectionStore: AnchorSelectionStore, @unchecked Sendable {
    ...
    public func loadSelections() -> [AnchorSelectionKey: String] {
    ...
    public func saveSelections(_ selections: [AnchorSelectionKey: String]) {
    ...
    public func loadCachedManifest() -> ContractsManifest? {
    ...
    public func saveCachedManifest(_ manifest: ContractsManifest) {
