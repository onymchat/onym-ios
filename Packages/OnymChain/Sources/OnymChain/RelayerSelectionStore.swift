...
public protocol RelayerSelectionStore: Sendable {
...
public struct UserDefaultsRelayerSelectionStore: RelayerSelectionStore, @unchecked Sendable {
    ...
    public func loadConfiguration() -> RelayerConfiguration {
    ...
    public func saveConfiguration(_ configuration: RelayerConfiguration) {
    ...
    public func loadCachedKnownList() -> [RelayerEndpoint] {
    ...
    public func saveCachedKnownList(_ list: [RelayerEndpoint]) {
