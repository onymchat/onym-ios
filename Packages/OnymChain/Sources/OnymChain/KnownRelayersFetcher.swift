...
public protocol KnownRelayersFetcher: Sendable {
...
public struct GitHubReleasesKnownRelayersFetcher: KnownRelayersFetcher {
    /// GitHub redirect that always resolves to the latest release's
    /// `relayers.json` asset. See
    /// https://docs.github.com/en/repositories/releasing-projects-on-github/linking-to-releases
    public static let defaultURL = URL(string: "https://github.com/onymchat/onym-relayer/releases/latest/download/relayers.json")!
    ...
    public func fetchLatest() async throws -> [RelayerEndpoint] {
...
public enum KnownRelayersFetchError: Error, Sendable {
    case badStatus(Int)
