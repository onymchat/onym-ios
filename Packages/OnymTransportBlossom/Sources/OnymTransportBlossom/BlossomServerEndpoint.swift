...
public struct BlossomServerEndpoint: Codable, Equatable, Hashable, Identifiable, Sendable {
    ...
    public init(name: String, url: URL, isDefault: Bool) {
        self.name = name
        self.url = url
    ...
    public static func custom(url: URL) -> BlossomServerEndpoint {
