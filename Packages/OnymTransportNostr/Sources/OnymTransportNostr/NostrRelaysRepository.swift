...
public actor NostrRelaysRepository {
    ...
    public init(store: any NostrRelaysSelectionStore, fetcher: (any KnownNostrRelaysFetcher)? = nil) {
        self.store = store
    ...
    public func currentEndpoints() -> [NostrRelayEndpoint] {
        cached.endpoints
    }
    ...
    @discardableResult
    public func addEndpoint(_ endpoint: NostrRelayEndpoint) -> Bool {
    ...
    public nonisolated var snapshots: AsyncStream<NostrRelaysConfiguration> {
