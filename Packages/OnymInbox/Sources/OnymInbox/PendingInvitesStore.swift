...
public protocol PendingInvitesRecording: Sendable {
...
/// identity.
public actor PendingInvitesStore: PendingInvitesRecording {
    ...
    public func record(_ invite: PendingInvite) async {
