...
/// `IdentityRepository`.
public struct InvitationDecryptor: Sendable {
    let envelopeDecrypter: any InvitationEnvelopeDecrypting

    public init(envelopeDecrypter: any InvitationEnvelopeDecrypting) {
    ...
    /// that identity.
    public func decrypt(_ invitation: IncomingInvitation) async throws -> DecryptedInvitation {
