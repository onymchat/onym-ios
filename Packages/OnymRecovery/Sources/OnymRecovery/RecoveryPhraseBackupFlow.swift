...
@MainActor
@Observable
public final class RecoveryPhraseBackupFlow {
    ...
    public enum VerifyState: Equatable {
        case idle
        case correct
        case wrong(String)
    }

    public struct VerifyRound: Equatable, Sendable {
        public let wordPosition: Int   // 1-based
    ...
    public private(set) var step: Step = .intro
    ...
    public var isReady: Bool { currentIdentity != nil }
    ...
    public func tappedContinueFromReveal() {
    ...
    public func picked(word: String) {
    ...
    public func tappedDoneFromCompletion() {
...
public struct UIPasteboardWriter: PasteboardWriter {
    public init() {}
    public func write(_ value: String, localOnly: Bool, expiresAt: Date) {
    ...
    public func clearIfStill(_ value: String) {
