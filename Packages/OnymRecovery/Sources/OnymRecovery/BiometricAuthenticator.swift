...
public struct LAContextAuthenticator: BiometricAuthenticator {
    ...
    #if DEBUG
    public static let failClosedByDefault = false
    #else
    public static let failClosedByDefault = true
    #endif
...
public struct AlwaysAcceptAuthenticator: BiometricAuthenticator {
    public init() {}
    public func authenticate(reason: String) async throws {}
}
#endif
