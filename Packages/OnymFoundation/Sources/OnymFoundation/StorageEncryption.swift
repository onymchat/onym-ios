...
public enum StorageEncryption {
    ...
    public static var storageKey: SymmetricKey {
        get throws {
    ...
    public static func decrypt(_ combined: Data) throws -> Data {
        let box = try AES.GCM.SealedBox(combined: combined)
        return try AES.GCM.open(box, using: try storageKey)
    }

    /// Decrypt to a UTF-8 string.
    public static func decryptString(_ combined: Data) throws -> String {
