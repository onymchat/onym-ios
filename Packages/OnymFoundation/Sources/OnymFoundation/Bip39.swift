...
public enum Bip39 {
    ...
    public static func mnemonicFromEntropy(_ entropy: Data) -> String {
    ...
    public static func entropyFromMnemonic(_ mnemonic: String) -> Data? {
    ...
    public static func isValidMnemonic(_ mnemonic: String) -> Bool {
    ...
    public static func seedFromMnemonic(_ mnemonic: String, passphrase: String = "") -> Data {
    ...
    public static func deriveNostrKey(from seed: Data) -> Data {
    ...
    public static func deriveBlsKey(from seed: Data) -> Data {
        let derived = HKDF<SHA256>.deriveKey(
            inputKeyMaterial: SymmetricKey(data: seed),
            salt: Data("app.onym.bip39".utf8),
