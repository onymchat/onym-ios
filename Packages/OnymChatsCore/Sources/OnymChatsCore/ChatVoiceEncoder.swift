...
public enum ChatVoiceEncoder {
    public struct Encoded: Equatable {
        ...
        public init(m4a: Data, durationSeconds: Double, waveform: [UInt8]) {
            self.m4a = m4a
    ...
    public static let waveformBarCount = 40
    ...
    public static func encode(fromAudioURL url: URL) async -> Encoded? {
    ...
    public static func downsample(_ samples: [Int16], barCount: Int) -> [UInt8] {
