...
public enum ChatImageEncoder {
    /// Longest-edge cap in pixels for the transmitted image.
    public static let maxEdge: CGFloat = 2048
    ...
    public static func encode(fromImageData data: Data) -> Encoded? {
        guard let image = UIImage(data: data) else { return nil }
        return encode(image)
    }

    public static func encode(_ image: UIImage) -> Encoded? {
