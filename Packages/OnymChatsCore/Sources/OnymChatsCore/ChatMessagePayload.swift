...
public struct ChatMessagePayload: Codable, Equatable, Sendable {
    ...
    public let variant: ChatMessageVariant
    ...
    public let attachment: ChatImageAttachment?
    ...
    public let attachments: [ChatMediaAttachment]?
...
public enum ChatMessageVariant: Equatable, Sendable {
