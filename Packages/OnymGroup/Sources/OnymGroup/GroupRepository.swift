...
public actor GroupRepository {
    ...
    public init(store: any GroupStore, currentIdentityID: IdentityID? = nil) {
        self.store = store
    ...
    public func markPublished(id: String, ownerID: IdentityID, commitment: Data?) async {
    ...
    public func markRead(id: String, ownerID: IdentityID, at date: Date) async {
    ...
    public func delete(id: String, ownerID: IdentityID) async {
    ...
    /// `snapshots`.
    public func currentGroups() async -> [ChatGroup] {
    ...
    public nonisolated var snapshots: AsyncStream<[ChatGroup]> {
