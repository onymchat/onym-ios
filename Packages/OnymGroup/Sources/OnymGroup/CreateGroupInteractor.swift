...
///    pick it up.
public struct CreateGroupInteractor: Sendable {
    ...
    public static func randomCanonicalFr() throws -> Data {
        while true {
    ...
    public static func isCanonicalFr(_ bytes: [UInt8]) -> Bool {
...
public enum CreateGroupProgress: Equatable, Sendable {
    case validating
    case proving
    case anchoring
...
public enum CreateGroupError: Error, Equatable, Sendable {
    case invalidName
