...
public struct IntroRequest: Equatable, Sendable {
    ...
    /// decrypts `payload`.
    public let targetIntroPublicKey: Data
    ...
    public init(
        id: String,
        targetIntroPublicKey: Data,
        payload: Data,
        receivedAt: Date
    ) {
        self.id = id
        self.targetIntroPublicKey = targetIntroPublicKey
