...
/// same bytes).
public struct MemberAnnouncementPayload: Codable, Equatable, Sendable {
    ...
    public let newMember: AnnouncedMember
    ...
    public struct AnnouncedMember: Codable, Equatable, Sendable {
        /// 48-byte arkworks-compressed BLS12-381 G1 pubkey.
        public let blsPub: Data
        /// 32-byte X25519 raw inbox public key.
        public let inboxPub: Data
...
public enum MemberAnnouncementPayloadError: Error, Equatable {
    case shape(String)
}
